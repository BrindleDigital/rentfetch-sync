...
function rfs_entrata_update_unit_meta( $args, $unit_data, $property_mits_data ) {
	...
	$meta = array(
		'unit_id' => sanitize_text_field( $unit_data['@attributes']['PropertyUnitId'] ?? '' ),
		'floorplan_id' => sanitize_text_field( $unit_data['@attributes']['FloorplanId'] ?? '' ),
		'property_id' => sanitize_text_field( $unit_data['@attributes']['PropertyId'] ?? '' ),
		'apply_online_url' => esc_url_raw( $apply_online_url ),
		'availability_date' => sanitize_text_field( $unit_data['@attributes']['AvailableOn'] ?? '' ),
		'building_name' => sanitize_text_field( $unit_data['@attributes']['BuildingName'] ?? '' ),
		'floor_number' => sanitize_text_field( $unit_data['@attributes']['FloorNumber'] ?? '' ),
