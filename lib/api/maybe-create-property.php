 ...
 *
 * @return  [type]  $args   return the args with the wordpress property ID added (whether we created one or just found that there was one already)
 */
function rfs_maybe_create_property( $args ) {
    ...
    if ( $property_posts ) {
        $args['wordpress_property_post_id'] = $property_posts[0]->ID;
        return $args;
    }
    ...
    $args['wordpress_property_post_id'] = $new_property_post_id;
    return $args;
